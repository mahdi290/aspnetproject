...
namespace Asp.Controllers
{
    public class ClientController : Controller
    {
                ...
                var claims = new List<Claim>
        {
            ...
            new Claim(ClaimTypes.NameIdentifier, dbClient.Id.ToString()) // Assuming dbClient has an Id property
        };
        ...
        {
            // Retrieve and display cart items for the user
            ...
            {
                // Fetch cart items for the current client
            ...
            return RedirectToAction("Login", "Client"); // Redirect to login if user is not authenticated
        }
        ...
        public IActionResult AddToCart(int productId)
        {
            try
            {
                ...
                if (clientIdClaim == null || !int.TryParse(clientIdClaim.Value, out int clientId))
                {
                    // Handle the case where clientIdClaim is null or not a valid integer
                ...
                return RedirectToAction("Index", "Client"); // Assuming you want to redirect to the client's cart or another page
            }
            catch (Exception ex)
            {
                // Log the error
